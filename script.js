...
console.log(`Today in ${location}, the weather is ${theWeather} and ${theTemp} degrees Fahrenheit`)
...
console.log(crazyScale + 3)
console.log(crazyScale + 1.1)
console.log(crazyScale * 3)
console.log((crazyScale / 7).toFixed(2))
console.log(crazyScale % 2)
/*
 * Prompt 4:
 *
...
let movies = ['Iron Giant', 'Frozen II', 'Little Miss Sunshine', 'Barbie']

console.log(movies[1])

movies.unshift('Mean Girls')
movies.push('Up')
movies.splice(2, 0, "Frozen I")
